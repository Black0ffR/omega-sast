...
[![Test Suite](https://img.shields.io/badge/tests-693%20passing-brightgreen)](test/)
...
│   ├── test-obfio-recovery.js     # Decoder evidence: hints, boost sync, second pass (23)
│   └── fixtures/
...
```bash
# Run all 693 tests (100% pass rate)
npm test
