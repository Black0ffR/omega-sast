...
[![Test Suite](https://img.shields.io/badge/tests-776%20passing-brightgreen)](test/)
...
│   ├── test-csrf-postdecode.js          # CSRF on decoded buffers + posture recompute (4)
│   ├── test-cred-neardup.js             # Credential prefix-merge with provenance (5)
│   ├── test-storage-bearer.js           # Storage key-exfil + Bearer linkage (5)
│   └── fixtures/
...
```bash
# Run all 776 tests (100% pass rate)
npm test
